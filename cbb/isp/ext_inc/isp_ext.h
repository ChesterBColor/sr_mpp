...
#define call_isp_drv_get_sync_id(vi_pipe, frame_info, is_current_frm) \
    func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_drv_get_sync_id(vi_pipe, frame_info, is_current_frm)
