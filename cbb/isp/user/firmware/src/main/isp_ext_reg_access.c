...
td_void isp_agamma_attr_write(ot_vi_pipe vi_pipe,
    const ot_isp_agamma_attr *agamma_attr, const ot_isp_agamma_attr *adgamma_attr)
{
    ot_ext_system_agamma_enable_write(vi_pipe, agamma_attr->enable);
    ot_ext_system_agamma_scale_write(vi_pipe, agamma_attr->scale);
    ot_ext_system_adgamma_enable_write(vi_pipe, adgamma_attr->enable);
    ot_ext_system_adgamma_scale_write(vi_pipe, adgamma_attr->scale);
}
