...
td_s32 sample_ot_mpi_awb_register(td_s32 vi_pipe, ot_isp_3a_alg_lib *awb_lib)
{
...
td_s32 sample_ot_mpi_awb_unregister(td_s32 vi_pipe, ot_isp_3a_alg_lib *awb_lib)
{
    td_s32 ret;
...
td_s32 sample_ot_mpi_awb_sensor_unreg_callback(ot_vi_pipe vi_pipe, ot_isp_3a_alg_lib *awb_lib, ot_sensor_id sensor_id)
{
    sample_awb_ctx_s *awb_ctx = TD_NULL;
    td_s32  handle;
