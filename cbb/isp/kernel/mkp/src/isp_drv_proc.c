...
static td_void isp_proc_module_param_show(ot_vi_pipe vi_pipe, isp_drv_ctx *drv_ctx, osal_proc_entry_t *s)
{
    ...
    osal_seq_printf(s, " %12u" " %12u" " %12u" " %12u" " %12u" " %12u" " %12u" "\n",
...
static td_void isp_proc_int_status_show(ot_vi_pipe vi_pipe, isp_drv_ctx *drv_ctx, osal_proc_entry_t *s)
{
    ...
    osal_seq_printf(s, "%11s" "%11s" "%11s" "%11s" "%11s" "%11s" "%9s" "%13s" "%16s\n",
                    "vi_pipe", "int_cnt", "int_t", "max_int_t", "int_gap_t", "max_gap_t", "int_rat",
                    "reset_cnt", "be_stat_lost");

    osal_seq_printf(s, "%11d" "%11d" "%11d" "%11d" "%11d" "%11d" "%9d" "%13d" "%16d\n\n", vi_pipe,
    ...
    osal_seq_printf(s, "%20s" "%20s" "%20s" "%22s\n",
                    "sync_cfg_gap", "sync_cfg_gap_max", "sync_cfg_gap_min", "ldci_comp_err_cnt");

    osal_seq_printf(s, "%17d" "%17d" "%17d" "%22d\n",
...
static td_void isp_proc_pub_attr_show(ot_vi_pipe vi_pipe, isp_drv_ctx *drv_ctx, osal_proc_entry_t *s)
{
    ...
    osal_seq_printf(s,
        "%7s" "%7s" "%7s" "%7s" "%7s" "%7s" "%10s" "%6s" "%8s" "%9s" "%8s" "%8s" "%8s" "%8s""%8s\n",
        "wnd_x", "wnd_y", "wnd_w", "wnd_h", "sns_w", "sns_h", "sns_mode",  "flip", "mirror",
        "crop_en", "crop_x", "crop_y", "crop_w","crop_h", "bayer");

    osal_seq_printf(s,
        "%7d" "%7d" "%7d" "%7d" "%7d" "%7d" "%10u"  "%6d" "%8d" "%9d" "%8d" "%8d" "%8u" "%8u" "%8s \n\n",
        ...
        drv_ctx->proc_pub_info.sensor_flip_en, drv_ctx->proc_pub_info.sensor_mirror_en,
