...
static td_s32 isp_drv_get_sync_id(ot_vi_pipe vi_pipe, const ot_video_frame_info *frame_info, td_bool current_frm)
{
    ...
    sync_id = isp_drv_get_be_sync_id(vi_pipe, current_frm);
    temp1 = misc_info->private_data[1] & 0xFFFFFFFF;
    temp2 = (((td_u64)sync_id << 32) & 0xFFFFFFFF00000000); /* left move 32bit */
    misc_info->private_data[1] = temp1 | temp2;
