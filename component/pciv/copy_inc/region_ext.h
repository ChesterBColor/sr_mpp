...
typedef struct {
    ...
    td_s32 (*pfn_rgn_query_region_num)(ot_rgn_type type, const ot_mpp_chn *chn, td_u32 *num);
...
#define ckfn_rgn_query_region_num() \
    (func_entry(rgn_export_func, OT_ID_RGN)->pfn_rgn_query_region_num != TD_NULL)

#define call_rgn_query_region_num(type, chn, num) \
    func_entry(rgn_export_func, OT_ID_RGN)->pfn_rgn_query_region_num(type, chn, num)
#ifdef __cplusplus
extern "C" {
#endif
